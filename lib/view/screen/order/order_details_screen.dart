...
import 'package:flutter_axtro_soft_ecommerce/view/basewidget/shimmer_loading.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/dashboard/dashboard_screen.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/order/widget/cal_chat_widget.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/order/widget/cancel_and_support_center.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/order/widget/ordered_product_list.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/order/widget/payment_info.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/order/widget/seller_section.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/order/widget/shipping_info.dart';
                  ...
                  if (order.orderDetails != null) {
                    ...
                    if (widget.orderType == 'POS') {
                      if (widget.extraDiscountType == 'percent') {
                        eeDiscount = _order * (widget.extraDiscount ?? 0 / 100);
                      } else {
                        eeDiscount = widget.extraDiscount ?? 0;
                      }
                    }
                  }
