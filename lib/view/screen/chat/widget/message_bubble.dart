...
import 'package:flutter_axtro_soft_ecommerce/view/basewidget/custom_image.dart';
...
class MessageBubble extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(crossAxisAlignment: CrossAxisAlignment.start,
      ...
      children: [
        isMe ? SizedBox.shrink() : InkWell(onTap: (){},
          ...
          child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                ...
                !isMe? Text(dateTime, style: titilliumRegular.copyWith(
                  ...
                  color: ColorResources.getHint(context),)) : SizedBox.shrink(),
