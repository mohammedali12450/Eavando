...
import 'package:flutter_axtro_soft_ecommerce/view/screen/wallet/widget/transaction_widget.dart';
    ...
    return Consumer<WalletTransactionProvider>(
      builder: (context, transactionProvider, child) {
        ...
        return Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
          ...
          !transactionProvider.firstLoading ? (transactionList != null && transactionList.length != 0) ?
          Container(
