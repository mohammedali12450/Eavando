...
import 'package:flutter_axtro_soft_ecommerce/data/model/body/order_place_model.dart';
...
import 'package:flutter_axtro_soft_ecommerce/view/basewidget/amount_widget.dart';
...
import 'package:flutter_axtro_soft_ecommerce/view/basewidget/my_dialog.dart';
import 'package:flutter_axtro_soft_ecommerce/view/basewidget/show_custom_snakbar.dart';
import 'package:flutter_axtro_soft_ecommerce/view/basewidget/textfield/custom_textfield.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/address/saved_address_list_screen.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/address/saved_billing_Address_list_screen.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/checkout/widget/custom_check_box.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/dashboard/dashboard_screen.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/payment/payment_screen.dart';
          ...
          child: Consumer<OrderProvider>(
            ...
            return !Provider.of<OrderProvider>(context).isLoading ? Builder(
              builder: (context) => InkWell(
                onTap: () async {
                  if(Provider.of<OrderProvider>(context, listen: false).addressIndex == null && !widget.onlyDigital) {
                    ...
                    showCustomSnackBar(getTranslated('select_a_billing_address', context), context);
                    ...
                    if(_cod && Provider.of<OrderProvider>(context, listen: false).paymentMethodIndex == 0 && !widget.onlyDigital) {
                      ...
                      Provider.of<OrderProvider>(context, listen: false).placeOrder(OrderPlaceModel(
                        ...
                        _cartList, order.paymentMethodIndex == 0 && !widget.onlyDigital? 'cash_on_delivery' : '', couponDiscount,
                      ), _callback, _cartList,
                          widget.onlyDigital ? '':
                          Provider.of<ProfileProvider>(context, listen: false).addressList[Provider.of<OrderProvider>(context, listen: false).addressIndex].id.toString(),
                          couponCode,
                  ...
                  return Container(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          ...
                          SizedBox(height: !widget.onlyDigital? Dimensions.PADDING_SIZE_SMALL:0),
                          _billingAddress?
                          Card(
                            child: Container(
                              padding: EdgeInsets.all(Dimensions.PADDING_SIZE_DEFAULT),
              ...
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                  ...
                  Expanded(child: Row(children: [
                    _cod && !widget.onlyDigital? Expanded(child: CustomCheckBox(title: getTranslated('cash_on_delivery', context), index: 0)):  SizedBox(),
                    _digitalPayment ? Expanded(
                      child: Container(
                          child: CustomCheckBox(title: getTranslated('digital_payment', context), index: !_cod  || widget.onlyDigital ? 0 : 1)),
                    ) : SizedBox(),
                  ],)),
                ]),
              ),
