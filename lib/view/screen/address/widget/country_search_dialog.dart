  ...
  Widget build(BuildContext context) {
    return Consumer<LocationProvider>(
        builder: (context,locationProvider,_){
          return locationProvider.restrictedCountryList != null && locationProvider.restrictedCountryList.length !=0?
          Padding(
            ...
            child: Container(
              ...
              child: ListView.builder(
                  ...
                  itemBuilder: (ctx,index){
                    return InkWell(
                      onTap: (){
                        print('you are clicked in ====>${locationProvider.restrictedCountryList[index]}');
                      ...
                      child: Container(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.start,crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text(locationProvider.restrictedCountryList[index], style: robotoRegular.copyWith(fontSize: Dimensions.FONT_SIZE_DEFAULT)),
