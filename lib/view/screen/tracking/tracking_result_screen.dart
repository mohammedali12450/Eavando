...
import 'package:flutter_axtro_soft_ecommerce/view/basewidget/custom_loader.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/dashboard/dashboard_screen.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/tracking/painter/line_dashed_painter.dart';
          ...
          Expanded(
            child: Consumer<OrderProvider>(
              builder: (context, tracking, child) {
                ...
                Center(child: Text('Failed')) : status == AppConstants.RETURNED ?
