...
import 'package:flutter_axtro_soft_ecommerce/view/screen/product/widget/bottom_cart_view.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/product/widget/product_image_view.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/product/widget/product_specification_view.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/product/widget/product_title_view.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/product/widget/promise_screen.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/product/widget/related_product_view.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/product/widget/review_widget.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/product/widget/seller_view.dart';
import 'package:flutter_axtro_soft_ecommerce/view/screen/product/widget/youtube_video_widget.dart';
    ...
    return WillPopScope(
      ...
      child: Scaffold(
        appBar: AppBar(
            ...
            InkWell(
              ...
              onTap: widget.isFromWishList
                  ? () => Navigator.of(context)
                      .pushReplacement(MaterialPageRoute(builder: (BuildContext context) => WishListScreen()))
          ...
          elevation: 0,
          backgroundColor:
              Provider.of<ThemeProvider>(context).darkTheme ? Colors.black : Theme.of(context).primaryColor,
        ),
                            ...
                            child: Column(
                              children: [
                                ...
                                (details.productDetailsModel.details != null &&
                                        details.productDetailsModel.details.isNotEmpty)
                                    ? Container(
                                        height: 250,
                                ...
                                details.productDetailsModel.videoUrl != null
                                    ? YoutubeVideoWidget(url: details.productDetailsModel.videoUrl)
                                    : SizedBox(),
                                Container(
                                ...
                                details.productDetailsModel.addedBy == 'seller'
                                    ? SellerView(sellerId: details.productDetailsModel.userId.toString())
                                    : SizedBox.shrink(),
                                Container(
                                  ...
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.center, children: [
                                    ...
                                    Container(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          RatingBar(
                                            rating: double.parse(details.productDetailsModel.averageReview),
                                            size: 18,
                                          ),
                                          SizedBox(width: Dimensions.PADDING_SIZE_DEFAULT),
                                          Text(
                                              '${double.parse(details.productDetailsModel.averageReview).toStringAsFixed(1)}' +
                                                  ' ' +
                                        ...
                                        onTap: () {
                                          if (details.reviewList != null) {
                                            Navigator.push(
                                                context,
                                                MaterialPageRoute(
                                                    builder: (_) => ReviewScreen(reviewList: details.reviewList)));
                                          }
                                        },
                                ...
                                details.productDetailsModel.addedBy == 'seller'
                                    ? Padding(
                                        padding: EdgeInsets.all(Dimensions.PADDING_SIZE_DEFAULT),
                                        child: TitleRow(
                                            title: getTranslated('more_from_the_shop', context), isDetailsPage: true),
                                      )
                                    : SizedBox(),
                                details.productDetailsModel.addedBy == 'seller'
                                    ? Padding(
                                        ...
                                        child: ProductView(
                                            ...
                                            sellerId: details.productDetailsModel.userId.toString()),
                                      )
                                    : SizedBox(),
                                Container(
                                  margin: EdgeInsets.only(top: Dimensions.PADDING_SIZE_SMALL),
        ...
        bottomNavigationBar: Consumer<ProductDetailsProvider>(builder: (context, details, child) {
