...
import 'package:flutter_axtro_soft_ecommerce/data/model/response/loyalty_point_model.dart';
...
import 'package:flutter_axtro_soft_ecommerce/view/screen/loyaltyPoint/widget/loyalty_point_widget.dart';
    ...
    return Consumer<WalletTransactionProvider>(
      builder: (context, loyaltyProvider, child) {
        ...
        return Column(crossAxisAlignment: CrossAxisAlignment.start,children: [
          ...
          !loyaltyProvider.firstLoading ? (loyaltyPointList != null && loyaltyPointList.length != 0) ?
          ListView.builder(
            shrinkWrap: true,
