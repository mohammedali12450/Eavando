...
import 'package:flutter_axtro_soft_ecommerce/data/repository/auth_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/banner_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/brand_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/cart_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/category_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/chat_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/coupon_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/featured_deal_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/flash_deal_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/location_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/notification_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/onboarding_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/product_details_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/order_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/product_repo.dart';
...
import 'package:flutter_axtro_soft_ecommerce/data/repository/wallet_transaction_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/data/repository/wishlist_repo.dart';
import 'package:flutter_axtro_soft_ecommerce/helper/network_info.dart';
...
import 'package:flutter_axtro_soft_ecommerce/provider/coupon_provider.dart';
import 'package:flutter_axtro_soft_ecommerce/provider/facebook_login_provider.dart';
...
import 'package:flutter_axtro_soft_ecommerce/provider/google_sign_in_provider.dart';
import 'package:flutter_axtro_soft_ecommerce/provider/home_category_product_provider.dart';
import 'package:flutter_axtro_soft_ecommerce/provider/localization_provider.dart';
import 'package:flutter_axtro_soft_ecommerce/provider/location_provider.dart';
import 'package:flutter_axtro_soft_ecommerce/provider/notification_provider.dart';
import 'package:flutter_axtro_soft_ecommerce/provider/onboarding_provider.dart';
