...
import 'package:flutter_axtro_soft_ecommerce/data/model/body/selected_shipping_type.dart';
...
import 'package:flutter_axtro_soft_ecommerce/data/model/response/chosen_shipping_method.dart';
import 'package:flutter_axtro_soft_ecommerce/data/model/response/product_model.dart';
import 'package:flutter_axtro_soft_ecommerce/data/model/response/response_model.dart';
import 'package:flutter_axtro_soft_ecommerce/data/model/response/shipping_method_model.dart';
import 'package:flutter_axtro_soft_ecommerce/data/model/response/shipping_model.dart';
...
class CartProvider extends ChangeNotifier {
  ...
  Future<void> getSelectedShippingType(
    ...
    if (apiResponse.response != null &&
      ...
      _selectedShippingTypeList.add(
        SelectedShippingType(
          sellerId: sellerId,
          selectedShippingType: _selectedShippingType ?? "",
        ),
      );
    } else {
      ApiChecker.checkApi(context, apiResponse);
