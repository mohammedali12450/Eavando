...
import 'package:flutter_axtro_soft_ecommerce/data/model/response/restricted_zip_model.dart';
...
class LocationProvider with ChangeNotifier {
  ...
  Future<ResponseModel> updateAddress(BuildContext context,
      {required AddressModel addressModel, required int addressId}) async {
    _isLoading = true;
    notifyListeners();
    _errorMessage = '';
    _addressStatusMessage = null;
