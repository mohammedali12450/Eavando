...
import 'package:flutter_axtro_soft_ecommerce/data/model/response/base/error_response.dart';
...
import 'package:flutter_axtro_soft_ecommerce/data/model/response/refund_info_model.dart';
import 'package:flutter_axtro_soft_ecommerce/data/model/response/refund_result_model.dart';
...
class OrderProvider with ChangeNotifier {
  ...
  Future<void> placeOrder(OrderPlaceModel orderPlaceModel, Function callback, List<CartModel> cartList, String addressID, String couponCode,String couponAmount, String billingAddressId, String orderNote) async {
    _isLoading = true;
    notifyListeners();
    ApiResponse apiResponse = await orderRepo.placeOrder(addressID, couponCode,couponAmount, billingAddressId, orderNote);
    _isLoading = false;
    if (apiResponse.response != null && apiResponse.response.statusCode == 200) {
      _addressIndex = null;
