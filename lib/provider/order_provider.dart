...
class OrderProvider with ChangeNotifier {
  ...
  List<OrderModel>? get pendingList => _pendingList?.reversed.toList();
  List<OrderModel> get deliveredList => _deliveredList.reversed.toList();
  List<OrderModel> get canceledList => _canceledList.reversed.toList();
