...
import 'package:flutter_axtro_soft_ecommerce/data/model/response/wishlist_model.dart';
...
class WishListProvider extends ChangeNotifier {
  ...
  void addWishList(int productID, {required Function feedbackMessage}) async {
