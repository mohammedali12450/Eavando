...
import 'package:flutter_axtro_soft_ecommerce/data/model/response/flash_deal_model.dart';
      ...
      if (apiResponse.response != null &&
        ...
        if (_flashDeal?.id != null) {
          ...
          _timer = Timer.periodic(Duration(seconds: 1), (timer) {
            _duration = (_duration ?? Duration.zero) - Duration(seconds: 1);
            notifyListeners();
          });

          ApiResponse megaDealResponse = await megaDealRepo
          ...
          if (megaDealResponse.response != null &&
            ...
            megaDealResponse.response!.data.forEach((flashDeal) =>
